...
export CATALINA_OPTS="-DENVIRONMENT=PROD -Dlog4j.ignoreTCL=true -D2FA_AUTH_CLASS=mat.server.twofactorauth.DefaultOTPValidatorForUser -D2FA_AUTH_CLASS1=mat.server.twofactorauth.DefaultOTPValidatorForUser -DBONNIE_RESPONSE_TYPE=code -DBONNIE_REDIRECT_URI=https//yourredirectURI.com -DBONNIE_CLIENT_ID=1234567890 -DBONNIE_URI=https://bonnieURL.org -DBONNIE_CLIENT_SECRET=1234567890 -DBONNIE_URI=https://bonnieURL.org -DALGORITHM=EncyptionAlgorithm -DPASSWORDKEY=PasswordKey -DFHIR_SRVC_URL=http://host.docker.internal:9080 -DQDM_QICORE_MAPPING_SERVICES_URL=http://host.docker.internal:9090 -DCQL_ELM_TRANSLATION_URL=http://host.docker.internal:7070 -DHARP_BASE_URL=https://coda-laxman-vijay.okta.com -DHARP_URL=https://coda-laxman-vijay.okta.com/oauth2/v1 -DHARP_CLIENT_ID=0oaxejjylnXIqI56y5d6 -DMAT_API_KEY=DISABLED -DVSAC_TICKET_URL_BASE=https://utslogin.nlm.nih.gov/cas/v1 -DVSAC_URL_BASE=https://vsac.nlm.nih.gov -Dgwt.codeserver.port=9876"
